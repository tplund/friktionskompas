...
# - blueprints/api_admin.py: /api/admin/status, /api/admin/clear-cache, /api/docs, /api/docs/openapi.yaml, /api/docs/openapi.json
# - blueprints/api_customer.py: /api/v1/assessments (GET, POST), /api/v1/assessments/<id>, /api/v1/assessments/<id>/results, /api/v1/units
# - blueprints/public.py: /, /landing, /robots.txt, /sitemap.xml, /verifyforzoho.html, /zoho-domain-verification.html
# - blueprints/auth.py: /login, /logout, /auth/<provider>, /auth/<provider>/callback, /register, /forgot-password, /reset-password, /resend-code
#
# Auth decorators (customer_api_required, etc.) are in auth_helpers.py
